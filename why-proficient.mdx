...
want to use it instead of implementing everything yourself. While you _certainly can_ implement your custom
solution, there are several good reasons why you should consider using Proficient instead.

## TL;DR

- an end-to-end solution, with which it takes <Tooltip tip="Assuming you're using the React SDK">**3 minutes**</Tooltip> not weeks to get a user-facing agent up and running in your app

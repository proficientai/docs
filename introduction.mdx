...
<Tip>
  For more advanced features, you need to use the [API](#proficient-apis), which lets you connect
  your agents to all parts of your application.
</Tip>

## Demo

Here is a short demo video (2 min, 27 sec) that shows how you can add an AI agent to your React application.
...
Proficient agents are abstract, generalized virtual robots that can be used for various purposes. In your
...
<Note>
  ...
  Proficient agent for your product. We'd be more than happy to help you.
</Note>
